...
export const SuMission = () => {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="20" cy="20" r="18" stroke="#10b981" strokeWidth="3" />
      <circle cx="20" cy="20" r="12" stroke="#0284c7" strokeWidth="3" />
      <circle cx="20" cy="20" r="6" fill="#10b981" />
      <path d="M20 2V8M20 32V38M2 20H8M32 20H38" stroke="#10b981" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
};
...
export const SuGoal = () => {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8 36V6L24 14L8 22" stroke="#10b981" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="#10b981" fillOpacity="0.2" />
      <line x1="8" y1="36" x2="8" y2="4" stroke="#0284c7" strokeWidth="3" strokeLinecap="round" />
    </svg>
  );
};
