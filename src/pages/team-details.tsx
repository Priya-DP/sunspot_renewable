          ...
          <div className="team-details-wrapper">
                ...
                <div className="team-details-content">
                  ...
                  <div className="progress-area mt-4">
                    <div className="progress-wrap">
                      ...
                      <div className="pro-items">
                        <div className="pro-head">
                          <h6 className="title">Technology Consultant</h6>
            ...
            <div className="team-single-history pt-5">
              ...
              <p className="mt-3">
                ...
                made of owl the is quis nostrud vitae exercitation ullamco
                laboris nisi ut aliquip ex ea dolor commodo consequat. Duis aute
                irure and dolor in reprehenderit The is ipsum dolor sit amet
                consectetur nulla adipiscing elit. Fusce eleifend porta arcu In
                hac habitasse the is platea augue thelorem turpoi dictumst. In
                lacus libero faucibus at malesuada sagittis placerat eros sed
                istincidunt augue ac ante rutrum sed the is sodales augue
                consequat..
              </p>
              <h5 className="pt-5">
              ...
              <p className="mt-3">
                Duis ac ligula vel enim vehicula semper. Praesent diam enim,
                ultricies sed pharetra in, vestibulum eget elit. Praesent
                condimentum, eros vitae feugiat faucibus, elit arcu commodo
                orci, et sodales orci lacus vel urna. Nullam sodales rhoncus
                nulla, quis gravida mauris blandit ut. Cras a massa non neque
                faucibus porta id et leo. Nunc sit amet volutpat libero.
                Maecenas aliquet blandit libero sit amet efficitur. Nam mauris
                nisi,
              </p>
            </div>
          </div>
