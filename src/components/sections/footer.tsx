...
const contactInfo = [
  ...
  },
  {
    icon: <SuLocation />,
    label: "Location",
    value: "#1,S.No8,Ponneri High Road, Manali New Town,\nTaminadu-600 103\n.",
  },
];
            ...
            >
              <div className="single-footer-widget">
                ...
                <div className="footer-content">
                  <p>
                    SUNSPOT Solar is a 100% Indian-owned company delivering
                    reliable, high-quality solar solutions from design to
                    installation.
                  </p>
        ...
        <div className="container">
          <div className="footer-wrapper d-flex align-items-center justify-content-between">
            <p className="wow slideLeft color-2" data-delay=".3">
              ...
              <Link to="index">SunSpot Renewable Energy</Link> • Distributed by{" "}
              <Link to="https://www.codedbydevi.site" target="_blank">
                Devipriya
              </Link>
            </p>
